...
/*
BS to AD
Code from https://github.com/techgaun/ad-bs-converter
*/
...
(function () {
    var daysInYear = 365,
        ...
        maxMonth = 12,
        maxDays = 32,
        base_ad = {year: 2015, month: 7, day: 17, dayOfWeek: 5},	
    ...
    this.daysBetween = function (firstDate, secondDate) {
        var oneDay = 24*60*60*1000; // hours*minutes*seconds*milliseconds
        var diffDays = Math.round(Math.abs((firstDate.getTime() - secondDate.getTime())/(oneDay)));
        return diffDays;
    }
    this.bs2ad = function (bs_date) {
        return offsetADDays(countBSDays(bs_date));
    }
    this.ad2bs = function (ad_date) {
        return offsetBSDays(countADDays(ad_date));
    }
})();